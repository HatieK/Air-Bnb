...
const EditRoomBookingManagement: React.FC<ModalProps> = ({
  isModalOpen,
  setIsModalOpen,
  dataEdit,
}) => {
  ...
  useEffect(() => {
    if (dataEdit) {
      setValue("id", dataEdit.id.toString()),
        setValue("maPhong", dataEdit.maPhong.toString()),
        // setValue("ngayDen", dataEdit.ngayDen.toString()),
        // setValue("ngayDi", dataEdit.ngayDi.toString()),
        setValue("soLuongKhach", dataEdit.soLuongKhach.toString()),
        setValue("maNguoiDung", dataEdit.maNguoiDung.toString());
    }
  }, [dataEdit]);
...
export default EditRoomBookingManagement;
